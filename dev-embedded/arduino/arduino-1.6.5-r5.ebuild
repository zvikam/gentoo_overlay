...
SRC_URI="https://github.com/${PN}/Arduino/archive/${PVR}.tar.gz mirror://gentoo/arduino-icons.tar.bz2"
...
java_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-1.6.5-r5-build.xml.patch
...
src_install() {
	...
	doins -r lib/*.txt lib/theme lib/*.png
