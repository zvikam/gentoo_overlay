...
SRC_URI="amd64? ( http://go.microsoft.com/fwlink/?LinkID=620884 -> ${PN}-${PV}-x64.zip )
	 x86? ( http://go.microsoft.com/fwlink/?LinkID=620885 -> ${PN}-${PV}-ia32.zip )
        "
...
src_install(){
        ...
        newicon resources/app/resources/linux/vscode.png ${PN}.png
